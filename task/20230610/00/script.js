...
class App3 {
    ...
    setPlanePos () {
        ...
        const pos = new THREE.Vector3(Math.cos(elapsed), Math.sin(elapsed), Math.sin(elapsed)).normalize()
    ...
    init () {
        ...
        this.earthMaterial = new THREE.MeshStandardMaterial({map: texture, color: 0xebebeb, wireframe: true})
        this.earthMesh = new THREE.Mesh(this.sphereGeometry, this.earthMaterial)

        this.scene.add(this.earthMesh)

        // airplane
        this.planeGeometry = new THREE.TorusGeometry(0.2, 0.05, 16.0, 16.0, Math.PI * 2.0)
